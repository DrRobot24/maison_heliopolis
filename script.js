/* ============================================
   ...
   TWO MODES:
   1) CHECK-IN LINK (sent via WhatsApp before arrival):
      ?checkin=1  → landing page for Camera 1
      ?checkin=2  → landing page for Camera 2
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function roomDisplayName(room) {
    return (room === '1' || room === '2') ? `Camera ${room}` : '';
  }
  ...
  function renderCheckinLanding() {
    ...
    <div class="checkin-landing">
      ...
      <div class="checkin-landing__card">
        ...
        ${roomDisplayName(checkinRoom) ? `<div class="checkin-landing__room-badge">${roomDisplayName(checkinRoom)}</div>` : ''}
      ...
      <footer class="checkin-landing__footer checkin-footer-dark">
        ...
        <div class="footer-cin"><span class="cin-item">CIN: IT089017C2DKRZXJTO</span><span class="cin-sep"> — </span><span class="cin-item">CIR: 19089017C265790</span></div>
    ...
    <section class="section section--white" id="review">
      <div class="container">
        <div class="review-box reveal">
          ...
          <a href="https://g.page/r/CZQoijj3ZdhqEBM/review" target="_blank" rel="noopener noreferrer" class="review-btn">
  ...
  function renderSteps(room) {
    const step2text = t(T.checkin.step2text).replace('{{room}}', `<strong>${room}</strong>`);
    return [
      { n: 1, title: t(T.checkin.step1title), text: t(T.checkin.step1text), imgs: ['public/01.jpeg', 'public/02.jpeg'] },
      { n: 2, title: t(T.checkin.step2title), text: step2text, imgs: ['public/06.jpeg'] },
      { n: 3, title: t(T.checkin.step3title), text: t(T.checkin.step3text), imgs: ['public/03.jpeg', 'public/04.jpeg'] },
      { n: 4, title: t(T.checkin.step4title), text: t(T.checkin.step4text), imgs: [] }
    ].map(s => `
      <div class="step">
